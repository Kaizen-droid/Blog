                ...
                <table class="table table-hover table-dark">
                    ...
                    <tbody id="tablaUsuarios">
                        <tr>
                            ...
                            <td>Admin</td>
                            <td>
                                <button class="btn btn-primary" data-toggle="modal" data-target="#modificaUsuario">
                                    <i class="material-icons align-middle">edit</i>
                                </button>
                                <button class="btn btn-danger" data-toggle="modal" data-target="#eliminaUsuario">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group">
                        ...
                        <input type="text" name="msgEditar" id="userEditar" class="form-control"
    ...
    <div class="modal fade" id="eliminaUsuario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Esta seguro de eliminar a el Usuario?</p>
                </div>
                <div class="modal-footer">
